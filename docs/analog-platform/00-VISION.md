...
Our platform needs only **4-6 core primitives** that compose into infinite complexity.
...
1. `01-PANTHEON.md` - The historical lineage we stand on
2. `02-ARCHITECTURE.md` - Technical layers and interfaces
3. `03-PRIMITIVES.md` - The four core operations
4. `04-MODULES.md` - Module types and specifications
5. `05-PROTOCOL.md` - Self-description and latency protocol
